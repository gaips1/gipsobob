...
first_quest = {
    ...
    "desc": "Добро пожаловать в систему квестов! Чтобы выполнить квест, вам нужно поцеловать 3 разных пользователей. Используйте ПКМ или долго нажмите на пользователя и выберите 'Поцеловать'.",
    "progress": 0,
    "progress_max": 3,
    "reward": 100,
    "id": "first_q",
